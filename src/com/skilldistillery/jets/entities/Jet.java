...
public abstract class Jet {
	...
	public void fly() {
		...
		System.out.println("The " + this.model + " can fly for " + timeInAirDouble + " hours at " + this.speed
				+ " miles per hour, covering about " + this.range + " miles!");
	}
